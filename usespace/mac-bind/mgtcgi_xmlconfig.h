...
#define MGTCGI_SYS_ONLINE_DATE_ID       57  //在线时间
#define MGTCGI_SYS_SERVER_INFO_ID       58  //远程服务器交互信息
#define MGTCGI_SYS_AUTH_ID			59 //无线AP认证配置
#define MGTCGI_SYS_URL_FILTER_ID           60  //URL过滤
